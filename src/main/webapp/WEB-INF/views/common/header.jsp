  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="custom-collapse">
      <ul class="nav navbar-nav navbar-left">
        ...
        <li class="dropdown"><a class="dropdown" href="../recipe/list_manage.do">원쿡레시피 <i
      ...
      <!--회원가입 -->
        ...
        <!--쇼핑카트 -->
        <c:if test="${loginUser.user_type == 'MEMBER'}">
          <li class="dropdown"><a class="dropdown" href="../pay/cart_list.do"><i class="fas fa-shopping-cart"></i></a>
          </li>
        </c:if>
        <c:if test="${empty loginUser}">
          <li class="dropdown"><a class="dropdown" href="../login_admission/login.do"><i
