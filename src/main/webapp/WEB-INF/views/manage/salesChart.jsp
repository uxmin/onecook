...
<title>ONECOOK: Manager Page</title>
<meta
	...
	<div class="wrapper ">
		<div class="sidebar" data-color="white" data-active-color="danger">
			<div class="logo">
				...
				</a> <a href="../" class="simple-text logo-normal"> ONECOOK <!-- <div class="logo-image-big">
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					<li class="active "><a href="salesChart.do"> <i
...
<!-- 			              </button> -->
<!-- 			            </div> -->
<!-- 			            <a class="navbar-brand" href="salesChart.do">Main</a> -->
<!-- 			          </div> -->
...
<!-- 			      </nav> -->
			...
			<div class="content" style="margin-top: 50px;">
										...
										<div class="numbers">
											<p class="card-category">
												<a href="order_check.do"
													style="text-decoration: none; color: #9A9A9A;">금일 상품주문</a>
											</p>
											<p class="card-title">${tdypaycount.today_paycount}건</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card-body ">
								<div class="row">
									...
									<div class="col-7 col-md-8" style="padding-left: 0">
										<div class="numbers">
											<p class="card-category">금일 매출</p>
											<p class="card-title">${tdypayamount.sum_price}&#8361;
											<p>
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-7 col-md-8">
										<div class="numbers">
											<p class="card-category">
												<a href="order_check.do"
													style="text-decoration: none; color: #9A9A9A;">환불요청 건</a>
											</p>
											<p class="card-title">${refund.thscount}건
											<p>
										</div>
									</div>
								</div>
										...
										<div class="numbers">
											<p class="card-category">
												<a href="oneInquiry.do"
													style="text-decoration: none; color: #9A9A9A;">총 상품문의</a>
											</p>
											<p class="card-title">${qna.varcount}건
											<p>
										</div>
									</div>
								</div>
					...
					<div class="col-md-5">
						<div class="card ">
							<div class="card-header ">
								<h5 class="card-title" style="margin: 10px 0 0 0">오늘 판매상품</h5>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card ">
							<div class="card-header ">
								<h5 class="card-title">주간매출 조회</h5>
								<p class="card-category">
									<input id="inputWeek_id" type="date" name="varWeekPayment"
										onchange="varWeekPaymentFunc(this.value)" />
								</p>
							</div>
							...
							<div class="card-footer ">
								<hr>
								<div class="stats">
									<i class="nc-icon nc-credit-card"></i><span
										class="varWeekPaymentChart_div"></span>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card ">
							<div class="card-header ">
								<h5 class="card-title">월간매출 조회</h5>
								<p class="card-category">
									<input id="inputMonth_id" type="month" name="vardate"
										onchange="varDateFunc(this.value)" />
								</p>
							</div>
							...
							<div class="card-footer ">
								...
								<div class="stats">
									<i class="nc-icon nc-credit-card"></i><span
										class="varDatePaymentChart_div"></span>
								</div>
							</div>
    ...
    $(document).ready(function() {
    	...
    	console.log($("#inputMonth_id"));
		console.log(year + "-" + month);
		// 특정 달의 확인 오늘로 설정
		$("#inputMonth_id").val(year + "-" + month);
		console.log($("#inputMonth_id").val());
		$("#inputMonth_id").change();
		// 특정 달의 확인 오늘로 설정
		$("#inputWeek_id").val(year + "-" + month + "-" + date);
		$("#inputWeek_id").change();
...
// 								title: "month"
						...
						$(".varDatePaymentChart_div").text(' 금월 판매금액 : ' + monthAllPrice + ' 원');
		...
		$.ajax({
			...
			success: function(list){
				...
				if(list.length == 0){
					...
					$("#varDatePaymentChart_div").empty();
					$(".varDatePaymentChart_div").empty();
					$("#varDatePaymentChart_div").text("데이터 없음");
				}
				else{
					var tArr = new Array();
					var monthAllPrice = 0;
		...
		$.ajax({
			...
			success: function(list){
				...
				if(list.length == 0){
					...
					$(".varWeekPaymentChart_div").empty();
					$("#varWeekPaymentChart_div").text("데이터 없음");
				}
				else{
					var tArr = new Array();
					var tmArr = new Array();
...
// 							title: "month"
					...
					function toggleDataSeries(e) {
						...
						$(".varWeekPaymentChart_div").text(' 금주 판매금액 : ' + monthAllPrice +' 원');
					}
				} 
			});
	}
...
window.onload = function () {
		...
		let day = today.getDay();  // 요일
		// 당월 매출수 확인
		$("#today_main_line").text(month +"월 매출");
