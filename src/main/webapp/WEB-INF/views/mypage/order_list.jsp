					...
					<div class="row">
						...
						<div class="col-sm-8 col-sm-offset-1" id="col-sm-8">
							<div class="comments" id="order_state">
								<h4 class="comment-title font-alt">주문내역</h4>
								<div class="col-sm-12 filter">

									<a class="current wow fadeInUp" href="order_list.do"
										data-filter="*" style="color: rgb(111, 184, 55);">전체</a>
									</li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a class="wow fadeInUp"
										href="select_month.do?month=1" data-filter=".illustration"
										data-wow-delay="0.2s">1개월</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
										class="wow fadeInUp" href="select_month.do?month=3"
										data-filter=".marketing" data-wow-delay="0.4s">3개월</a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a class="wow fadeInUp"
										href="select_month.do?month=6" data-filter=".photography"
										data-wow-delay="0.6s">6개월</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
										class="wow fadeInUp" href="select_month.do?month=12"
										data-filter=".webdesign" data-wow-delay="0.6s">1년</a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<!--                   			<a class="wow fadeInUp" href="one_month.do" data-filter=".illustration" data-wow-delay="0.2s">1개월</a> -->
									<!--                   			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
									<!--                   			<a class="wow fadeInUp" href="three_month.do" data-filter=".marketing" data-wow-delay="0.4s">3개월</a> -->
									<!--                   			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
									<!--                   			<a class="wow fadeInUp" href="six_month.do" data-filter=".photography" data-wow-delay="0.6s">6개월</a> -->
									<!--                   			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
									<!--                   			<a class="wow fadeInUp" href="one_year.do" data-filter=".webdesign" data-wow-delay="0.6s">1년</a> -->
								</div>

								<table class="table table-hover" id="last_order_id">
									<tr>
										<th id="order_list_table">주문번호</th>
										<th id="order_list_table">주문날짜</th>
										<th id="order_list_table">사용 포인트</th>
										<th id="order_list_table">총 결제금액</th>
										<th id="order_list_table">주문현황</th>
									</tr>
								...
								<div class="row_paging_class">
									...
									<form action="order_list.do" method="post" id='frmPaging'>
